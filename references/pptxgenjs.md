...
The compile script passes a theme object with these keys. Use no others.
...
## Page Number Badge (every slide except Cover)
...
Convert slides to images using the bundled scripts:
